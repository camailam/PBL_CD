...
# File: PROJETOFINALPBLCD2.tcl
# Generated on: Wed Sep 20 22:14:36 2023
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "PROJETOFINALPBLCD2"]} {
		puts "Project PROJETOFINALPBLCD2 is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists PROJETOFINALPBLCD2]} {
		project_open -revision PROJETOFINALPBLCD PROJETOFINALPBLCD2
	} else {
		project_new -revision PROJETOFINALPBLCD PROJETOFINALPBLCD2
	}
